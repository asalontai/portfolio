            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {projects.map((project, index) => (
                        <div key={index} className="glass-card overflow-hidden group border-blue-500/10 hover:border-blue-500/20">
                            <div className="relative h-48 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 overflow-hidden flex items-center justify-center">
                                <div className="text-6xl opacity-30">{index === 0 ? '☁️' : index === 1 ? '🧮' : index === 2 ? '🔒' : '⚾'}</div>
                            </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {project.technologies.slice(0, 5).map((tech) => (
                                        <span key={tech} className="px-2 py-1 text-xs font-medium bg-blue-500/10 text-blue-300/80 rounded border border-blue-500/20">
                                            {tech}
                                        </span>
                                    ))}
                                    {project.technologies.length > 5 && (
                                        <span className="px-2 py-1 text-xs font-medium bg-blue-500/10 text-blue-300/80 rounded border border-blue-500/20">
                                ...
                                <div className="flex items-center gap-4">
                                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-blue-400 hover:text-blue-300 transition-colors">
                ...
                <div className="text-center mt-12">
                    <a href="https://github.com/asalontai" target="_blank" rel="noopener noreferrer" className="btn-secondary">
                        View All Projects
